...
Based on sp3predict, but cleaned, resiliant and tested.
'''
import argparse
import logging
import os
...
def populateMutations(vcfStem: str, outputDir: str, diff: gumpy.GenomeDifference, reference: gumpy.Genome, sample: gumpy.Genome, resistanceCatalogue: piezo.ResistanceCatalogue) -> pd.DataFrame:
...
def populateEffects(vcfStem: str, outputDir: str) -> None:
    pass
